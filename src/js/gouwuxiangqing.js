    $(function() {
        ...
        // 如果用户不是通过点击首页图片进来，而是通过地址直接进来，会让他返回首页，因为直接地址访问没传id   网页没渲染。
        if (id == '') {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                data.forEach((elm, i) => {
                    temp = `
                            <div><a href="">首页</a>&nbsp;&gt;&nbsp;<a href="">双11专区</a>&nbsp;&gt;&nbsp;<a href="">${elm.x_leixing}</a>&nbsp;&gt;&nbsp;<a href="">${elm.x_zhonglei}</a></div>
                            `;
                    jump = `
                            <div class="ban" id="demo1">
                                    ${elm.x_miaoshu}
                <div class="guanzhu"><span></span>${elm.x_guanzhu}</div>
            </div>
            <div>
                <h1>${elm.x_zhonglei}</h1>
                <p>${elm.x_kouhao}</p>
                <p>${elm.x_jiage}</p>
                <div>运费：&nbsp;&nbsp;&nbsp;&nbsp;上海 至&nbsp;&nbsp;&nbsp;&nbsp;
                    <div><input type="text" id="city" value="北京-北京市-石景山区" />&nbsp;&nbsp;快递：￥18.00</div>
                </div>
                <div>数量:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="1"><span class="jian">-</span><span class="jia">+</span></div>
                <a href="">立即购买</a><a href="javaScript:;">加入购物车</a>
            </div>
                            `
                });
                $('.one').append(temp);
                ...
                // 轮播图
                // var $ = $.noConflict();这里遇到$控制权问题   注释掉这局代码可以解决
                ...
                // 控制商品轮播图 多功能  由于功能需要  有的样式删掉了 像弹出框
                $('#demo1').banqh({
                    box: "#demo1", //总框架
                    pic: "#ban_pic1", //大图框架
                    pnum: "#ban_num1", //小图框架
                ...
                $('.jia').on('click', function() {
                    ...
                    let re = /^\d+.?\d*$/;
                    if (!re.test($('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val()) || $('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val() < 1) {
                        $('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val('1')
                    }
                    $('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val(parseInt($('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val()) + 1);
                })
                ...
                $('.jian').on('click', function() {
                    ...
                    $('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val(parseInt($('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val()) - 1);
                    // 让数量不能小于1
                    if (parseInt($('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val()) < 1) {
                        $('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val('1');
                    }
                })

                //   如果用户输入的内容 是非数字或者小于1的数字   默认变为1
                $('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').on('change', function() {
                    let re = /^\d+.?\d*$/;
                    if (!re.test($('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val()) || $('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val() < 1) {
                        $('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val('1')
                    }
                ...
                // 点击加入购物车让他的弹窗出现
                $('.two>div:nth-of-type(2)>a:nth-of-type(2)').on('click', function() {
                ...
                // 加入购物车弹窗
                // 实现购物车弹窗的消失与出现和跳转 以及将数据传入cookie
                // 获取用户点击商品id和数量
                $('.jiaru>p>span').on('click', function() {
                    $('.jiaru').css('display', 'none')
                })
                $('.jiaru>a:first').on('click', function() {
                    $('.jiaru').trigger('click')
                })
                $('.jiaru>a:last').on('click', function() {
                    let re = /^\d+.?\d*$/;
                    if (!re.test($('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val()) || $('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val() < 1) {
                        $('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val('1')
                    }
                    let num = $('.two>div:nth-of-type(2)>div:nth-of-type(2)>input').val();
                    cookie.set(`id`, id, 1);
